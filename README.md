...
Although this version of CSGLD has a global statbility condition, it doesn't handle **high-loss** problems appropriately. Please wait for the acceptance of a follow-up paper (submitted) that solves the long-standing scalability problem (in terms of dimension) for importance sampling.
