...
Although this version of CSGLD has a global statbility condition, it doesn't handle **high-loss** problems appropriately. Please wait a few months to check for the follow-up papers. 
